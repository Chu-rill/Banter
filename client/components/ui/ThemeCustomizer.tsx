  ...
  useEffect(() => {
    if (typeof window !== "undefined") {
      ...
      const savedReducedMotion =
        localStorage.getItem("banter-reduced-motion") === "true";
      const savedHighContrast =
        localStorage.getItem("banter-high-contrast") === "true";
      const savedColorScheme = parseInt(
        localStorage.getItem("banter-color-scheme") || "0"
      );
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 gap-3">
              {colorSchemes.map((scheme, index) => (
                ...
                >
                  <div
                    className={cn("w-8 h-8 rounded-full mr-3", scheme.preview)}
                  />
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-4 gap-2">
              {[
                ...
                >
                  <span className={cn("text-xs font-medium", `text-${value}`)}>
                    Aa
                  </span>
